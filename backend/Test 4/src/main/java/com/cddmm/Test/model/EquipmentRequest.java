...
public class EquipmentRequest {
    ...
    public EquipmentRequest(EquipmentId id, String equipmentDesc, String rangeee, String desiredAccuracy, String frequency, LocalDate lastCalib, int intimitationDays, String status, String remarks) {
        this.id = id;
    ...
    public LocalDate getDueDate(LocalDate lastCalib,int intimitationDays){
        return lastCalib.plusDays((long)intimitationDays);
    }
}
